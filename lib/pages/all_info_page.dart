...
class AllInfoPage extends StatefulWidget {
  const AllInfoPage({
    super.key,
    required this.image,
    required this.name,
  ...
  @override
  State<AllInfoPage> createState() => _ImagePageState();
}

class _ImagePageState extends State<AllInfoPage> {
  @override
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style: GoogleFonts.cabin(textStyle: TextStyle(fontSize: 16.sp)),
              ),
            ),
          ],
        ),
